...
s32 DoPoisonFieldEffect(void)
{
    ...
    {
        if (GetMonData(pokemon, MON_DATA_SANITY_HAS_SPECIES) && GetAilmentFromStatus(GetMonData(pokemon, MON_DATA_STATUS)) == AILMENT_PSN && GetMonAbility(pokemon) != ABILITY_POISON_HEAL && GetMonAbility(pokemon) != ABILITY_IMMUNITY && GetMonAbility(pokemon) != ABILITY_MAGIC_GUARD)
        {
